...
/* harmony default export */ var scrollTo = ({
  scroll: function scroll() {
    ...
    var targetElement = document.querySelector('.nav__list ');
...
/* harmony default export */ var slider = ({
  init: function init() {
    ...
    var swiperMob = new core('.swiper-mob', {
      modules: [Navigation, Pagination, Autoplay, EffectFade],
      speed: 900,
      pagination: {
...
;// CONCATENATED MODULE: ./src/modules/itc-custom-select.js
...
/* harmony default export */ var itc_custom_select = ({
  init: function init() {
    ...
    var select1 = new ItcCustomSelect('#select-1');
    var options = document.querySelectorAll('.itc-select__option');
    var isUkr = window.location.pathname === '/rus.html';
    if (isUkr) {
      var btn = document.querySelector('.itc-select__toggle');
      btn.dataset.index = '1';
...
;// CONCATENATED MODULE: ./src/modules/random.js
/* harmony default export */ var random = ({
  init: function init() {
    var showBtn = document.querySelector('.about__txt-btn');
    var showBtcontent = document.querySelector('.about__txt-hiden');
    if (!showBtn) return;
